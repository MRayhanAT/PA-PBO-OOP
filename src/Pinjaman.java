...
abstract class AbstractPinjaman implements PinjamanInterface {
    ...
    public AbstractPinjaman(int jumlahPinjaman, int jangkaWaktuPinjaman, double bungaPinjaman, String statusPinjaman, String namaPeminjam) {
    ...
    public int getJangkaWaktuPinjaman() { return jangkaWaktuPinjaman; }
    public void setJangkaWaktuPinjaman(int jangkaWaktuPinjaman) { this.jangkaWaktuPinjaman = jangkaWaktuPinjaman; }
    public double getBungaPinjaman() { return bungaPinjaman; }
    public void setBungaPinjaman(double bungaPinjaman) { this.bungaPinjaman = bungaPinjaman; }
...
public class Pinjaman extends AbstractPinjaman {
    public Pinjaman(int jumlahPinjaman, int jangkaWaktuPinjaman, double bungaPinjaman, String statusPinjaman, String namaPeminjam) {
    ...
    public void setStatusPinjaman(String statusPinjaman) {
        // Validasi status yang diperbolehkan: Menunggu, Disetujui, Ditolak, Lunas, Belum Lunas, Dalam Proses
        String[] validStatuses = {"Menunggu", "Disetujui", "Ditolak", "Lunas", "Belum Lunas", "Dalam Proses"};
        ...
        if (isValid) {
            ...
            System.out.println("Status tidak valid. Gunakan: Menunggu, Disetujui, Ditolak, Lunas, Belum Lunas, atau Dalam Proses.");
        }
    }
}
